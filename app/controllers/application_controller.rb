class ApplicationController < ActionController::Base
	...
	def sign_in(user)
	  	cookies.permanent.signed[:user_id] = user.id # Se agrega una Cookie
	  	@current_user = user
	end

	# Metodo para cerrar sesion del usuario
	def sign_out
		cookies.delete(:user_id) # Se elimina el usuario de la Cookie
	  	@current_user = nil
	end
	...
	private
		...
		# Metodo que valida si el Usuario ya esta autenticado lo redirijja a la pagina principal
		def public_access
